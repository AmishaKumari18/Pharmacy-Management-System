...
public class Tables {
    public static void main(String[] args){
        try{
            ...
            st.executeUpdate("create table if not exists appuser(appuser_pk int AUTO_INCREMENT primary key, userRole varchar(256), name varchar(256), dob varchar(50), mobileNumber varchar(50), email varchar(256), username varchar(256), password varchar(50), address varchar(256) )");
            ...
            st.executeUpdate("create table bill(bill_pk int AUTO_INCREMENT primary key, billId varchar(256), billDate varchar(256), totalPaid bigint, generatedBy varchar(256))");
