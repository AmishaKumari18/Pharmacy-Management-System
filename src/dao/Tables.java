...
public class Tables {
    public static void main(String[] args){
        try{
            ...
            st.executeUpdate("create table if not exist medicine (medicine_pk int AUTO_INCREMENT primary key, uniqueId varchar(256), name varchar(256), companyName varchar(256), quantity bigint, price bigint);");
